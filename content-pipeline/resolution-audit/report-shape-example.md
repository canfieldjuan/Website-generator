...
Use this when a model needs to understand the current Resolution Audit
...
The current report shape keeps that and adds:
...
The current report is a ranked action queue with cost, evidence, content output,
